...
@Updater(name = "Test Updater 6", path = "", xpath = "//element(*, hippo:document)"
        , description = "Test Mixin", batchSize = 1L, throttle = 200L, dryRun = true
        , mixin = "mixin:test, mixin:test1,mixin:test2,  mixin:test3, mixin:test4")
