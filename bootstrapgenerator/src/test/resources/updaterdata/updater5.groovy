...
@Updater(name = "Test Updater 5", path = "", xpath = "//element(*, hippo:document)"
        , description = "Test thing", batchSize = 1L, throttle = 200L, dryRun = true, parameters = "/updaterdata/parameters/updater4.json")
